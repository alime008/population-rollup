...
with open ('insight_testsuite\\tests\\test_1\input\censustract-00-10.csv','r') as file:
...
with open('insight_testsuite\\tests\\test_1\output\\report.csv', 'w', encoding="ISO-8859-1", newline='') as file:
    wr = csv.writer(file)
